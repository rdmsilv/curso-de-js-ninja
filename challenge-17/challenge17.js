(function(){
	...
	*/
    ...
    "Manuel Marques de Sousa, Conde de Porto Alegre (Rio Grande, 13 de junho de 1804 – Rio de Janeiro, 18 de julho de 1875), apelidado de 
	...
	*/
	...
	var regexNatural = /Feira de Santana/g;
	var natural = 'feirense';
	console.log(text.replace(regexNatural, natural));
	...
	*/
	...
	console.log(text.replace(regexNumber, '-'));
	...
	*/
	...
	var regexChar = /[D-Hd-h]/g;
	console.log(text.replace(regexChar, 0));
	...
	*/
	...
	var regexOneChar = /[Aa]/g; // /a/gi
	console.log(text.replace(regexOneChar, 4));
	...
	*/
	...
	var regexPhrase = /(O Centauro de Luvas)/;
	text.replace(regexPhrase, function (phrase) {
