(function () {
	...
	*/
	...
	var regexMaskCpf = /(\d{3})(\d{3})(\d{3})(\d{2})/;
	listCpf.forEach(function (cpf) {
		console.log(cleanCPF(cpf).replace(regexMaskCpf, '$1.$2.$3-$4'));
		// console.log(cleanCPF(cpf).replace(regexMaskCpf, 
